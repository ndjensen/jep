 ...
 * Last but not least, closing the Jep instance that created this JPyObject will
 ...
 * @since 3.8
 */
public class JPyObject implements AutoCloseable {
     ...
     * @param jep
     *            the Jep instance creating this JPyObject
     * @throws JepException
     */
    protected JPyObject(long tstate, long pyObject, Jep jep)
            throws JepException {
        if (pyObject == 0) {
    ...
    public String toString() {
        try {
            ...
            if (strMethod != null) {
                if (strMethod instanceof JPyCallable) {
                    Object str = ((JPyCallable) strMethod).call();
                    if (str != null) {
                        return str.toString();
                    } else {
