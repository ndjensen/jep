 ...
 * @since 3.8
 */
public class JPyCallable extends JPyObject {

    public JPyCallable(long tstate, long pyObject, Jep jep) {
        super(tstate, pyObject, jep);
    }

    public Object call(Object... args) throws JepException {
        isValid();
        return call(this.tstate, this.pyObject, args, null);
    }

    public Object call(Map<String, Object> kwargs) throws JepException {
        isValid();
        return call(this.tstate, this.pyObject, null, kwargs);
    }

    public Object call(Object[] args, Map<String, Object> kwargs)
            throws JepException {
        isValid();
        return call(this.tstate, this.pyObject, args, kwargs);
    }
